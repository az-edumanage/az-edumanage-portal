...
const P0_ROUTES: Array<{ key: string; path: string; role: UserRole }> = [
  ...
  { key: 'owner-security', path: '/owner/security', role: 'owner' },
  { key: 'owner-notifications', path: '/owner/notifications', role: 'owner' },
  { key: 'owner-modules', path: '/owner/modules', role: 'owner' },
  { key: 'owner-integrations', path: '/owner/integrations', role: 'owner' },
