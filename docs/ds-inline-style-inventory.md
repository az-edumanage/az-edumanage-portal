...
| `src/app/features/owner/pages/owner-billing/owner-billing-page.component.html` | 1 | `[style.height.%]` | P0 | Chart-bar dynamic style; migrate via CSS custom property binding. |
...
| `src/app/features/owner/pages/owner-overview/owner-overview.component.html` | 1 | `[style.width.%]` | P0 | Region progress bars; high-visibility dashboard. |
