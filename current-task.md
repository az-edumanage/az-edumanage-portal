...
- [x] Migrate additional large page VM/data orchestration out of component (completed: `owner-audit-logs`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `owner-provisioning-list`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `owner-modules-list`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `tenant-schedule`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `owner-integrations-list`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `owner-plans-list`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `owner-subscriptions-list`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `owner-subscription-templates-list`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `owner-notifications-list`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `teacher-media`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `owner-usage-analytics`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `owner-monitoring`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `owner-plan-details`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `owner-module-details`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `tenant-room-details`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `owner-academic-structure-details`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `tenant-group-details`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `tenant-grade-details`).
- [x] Migrate additional large page VM/data orchestration out of component (completed: `tenant-group-attendance`).
