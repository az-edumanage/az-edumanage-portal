...
function cleanup(dir) {
  ...
  for (const file of files) {
    ...
    if (fs.statSync(fullPath).isDirectory()) {
      ...
      // If a file is e.g. src/app/features/owner/owner-overview.component.ts 
      // AND src/app/features/owner/owner-overview (a directory) exists, we should delete the file.
      // But we shouldn't delete src/app/features/owner/owner-overview/owner-overview.component.ts!
