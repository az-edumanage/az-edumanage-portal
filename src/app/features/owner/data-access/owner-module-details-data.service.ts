...
import {
  ...
  ModuleDetailsPreset,
  TenantOverride,
} from '../models/owner-module-details.models';

@Injectable({ providedIn: 'root' })
export class OwnerModuleDetailsDataService {
  private readonly studentFeatures: Feature[] = [
  ...
  private readonly userFeatures: Feature[] = [
  ...
  private readonly schedulingFeatures: Feature[] = [
  ...
  getPreset(id: string): ModuleDetailsPreset {
    if (id === 'mod-users') {
      return {
        module: {
          id: 'mod-users',
    ...
    if (id === 'mod-sched') {
      return {
        ...
        features: this.schedulingFeatures,
        limits: [
