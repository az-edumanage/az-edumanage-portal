...
import {
  AcademicStructureChangeLog,
  AcademicStructureFeature,
  AcademicStructureLimit,
  AcademicStructureTab,
  AcademicStructureTenantOverride,
} from '../models/owner-academic-structure-details.models';

@Injectable({ providedIn: 'root' })
export class OwnerAcademicStructureDetailsDataService {
  readonly tabs: AcademicStructureTab[] = [
  ...
  readonly features: AcademicStructureFeature[] = [
  ...
  readonly limits: AcademicStructureLimit[] = [
  ...
  readonly overrides: AcademicStructureTenantOverride[] = [
  ...
  readonly changeLogs: AcademicStructureChangeLog[] = [
