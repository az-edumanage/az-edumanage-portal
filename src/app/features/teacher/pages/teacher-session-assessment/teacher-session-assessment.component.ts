...
@Component({
  selector: 'app-teacher-session-assessment',
  standalone: true,
  ...
  template: `
    <section class="page">
      <header>
        ...
        <p>Session assessment notes and grades from your assigned groups.</p>
      </header>
...
export class TeacherSessionAssessmentComponent {}
